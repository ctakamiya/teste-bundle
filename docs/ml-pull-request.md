...
Opening a pull request will trigger a[workflow](../.github/workflows/roteiro_ds_01-run-tests.yml) 
...
Links:
* [Staging model in UC](https://dbc-6ebed6cf-b45e.cloud.databricks.com/explore/data/models/staging/roteiro_ds_01/roteiro_ds_01-model)
* [Prod model in UC](https://dbc-530312ad-73ca.cloud.databricks.com/explore/data/models/prod/roteiro_ds_01/roteiro_ds_01-model)
. 
