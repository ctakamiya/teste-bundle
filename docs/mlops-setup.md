...
git add README.md docs .gitignore roteiro_ds_01/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://dbc-6ebed6cf-b45e.cloud.databricks.com#setting/accounts) and
  [prod workspace admin console](https://dbc-530312ad-73ca.cloud.databricks.com#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[roteiro_ds_01/databricks.yml](../roteiro_ds_01/databricks.yml) file.
...
Follow the instructions in [roteiro_ds_01/resources/README.md](../roteiro_ds_01/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../roteiro_ds_01/resources/README.md)  to propose, test, and deploy
