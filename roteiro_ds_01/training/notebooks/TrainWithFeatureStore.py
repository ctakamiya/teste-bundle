...
# ``roteiro_ds_01/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-roteiro_ds_01-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.producer.roteiro_ds_01-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.producer.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.producer.trip_dropoff_features",
